			...
			<div class="row">
									...
									<div class="product-info">
										...
										<div class = "wishyWishy">
											@if($wishItems->contains($product->id))
												<a href="#" wire:click.prevent = "removeFromWishlist({{ $product->id }}, '{{ $product->name }}', {{ $product->regular_price }} )"><i class = "fa fa-heart fill-heart"></i></a>
											@else
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget widget-product">
						...
						<div class="widget-content">
							@foreach($products as $product)
							<ul class = "list-products col-lg-4 col-md-6 col-sm-6 col-xs-6">
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6">
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="{{ route('product.details', ['slug' => $product->slug])}}" title="{{ $product->name }}">
